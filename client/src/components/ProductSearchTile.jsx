...
const Products = () => {
    ...
    useEffect(() => {
        ...
        console.log("On the searching COmpoentn");
  ...
  const [searched, setSearched] = useState(location.state?.searchQuery || '');

  // UPDATE: Add this useEffect to sync searched state when location changes
useEffect(() => {
  if (location.state?.searchQuery) {
    setSearched(location.state.searchQuery);
  }
        ...
        <div className='relative px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-20 py-8'>
          ...
          <div className='mb-8'>
            <motion.div
              ...
              <div>
                <h1 className='text-xl font-medium text-gray-800 mb-2 capitalize opacity-60'>Result for "{searched}"</h1>
