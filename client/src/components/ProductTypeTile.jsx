...
const ShoppingCart = React.lazy(
  () => import("lucide-react/dist/esm/icons/shopping-cart.js"),
);
import {
...
const ProductTypeTile = () => {
  ...
  function toggleWishlist(e, pid) {
    ...
    if (oldWishlist.includes(pid)) {
      ...
      dispatchWishlistEvent(WISHLIST_EVENTS.ITEM_REMOVED, {
        pid,
      ...
      // Dispatch wishlist event
      dispatchWishlistEvent(WISHLIST_EVENTS.ITEM_ADDED, {
        pid,
        wishlistCount: newWishlist.length,
      });
    }
  ...
  function handleAddToCart(e, pid, image, brand, name, price) {
    ...
    // Dispatch cart event
    dispatchCartEvent(CART_EVENTS.ITEM_ADDED, {
      pid,
      cartCount: oldCart.length,
    });
  }
  ...
  return (
    <>
                      ...
                      <div className="relative overflow-hidden">
                        ...
                        {count > 0 && rating > 0 && (
                          <div className="absolute bottom-3 left-3 bg-white/95 backdrop-blur-sm rounded-xl px-3 py-1.5 shadow-md flex items-center gap-2">
                            ...
                            <Star
                              className="text-green-400 text-sm fill-green-400"
                              size={15}
                            />
      ...
      {/* we will add recommended products later */}
    </>
  );
};
